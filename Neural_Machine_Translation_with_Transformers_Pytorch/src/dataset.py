import torch
from .tokenization import get_tokenizers
...
def build_dataset(config, raw_data, src_tokenizer, tgt_tokenizer):
    # train-validation split
    train_ds_raw, val_ds_raw = torch.utils.data.random_split(raw_data, [config["train_size"], config["val_size"]])
